        ...
        .then(sites => {
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    window.location.href = `/site/edit?id=${siteId}`;
                });
            });
...
/**
 * Ouverture de la pop-up de suppression de site
 */
function openPopup() {
...
/**
 * Fermeture de la pop-up de suppression de site
 */
function closePopup() {
    siteToDelete = null;
