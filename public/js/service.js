document.addEventListener("DOMContentLoaded", function () {
    ...
    let serviceToDelete = null; // Déclaration correcte en global
    ...
    function loadServices() {
        fetch("https://localhost:7250/Services")
            ...
            .then(services => {
                console.log("Réponse de l'API Services :", services);
                allServices = services; // Stocke tous les services
                ...
                document.querySelectorAll(".edit-btn").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        window.location.href = `/service/edit?id=${serviceId}`; // Redirection vers la page de modification
                    });
                });
...
function filterServices(searchTerm) {
    ...
    // Ajouter les services filtrés dans la table
    ...
    // Réattacher les événements aux nouveaux boutons "Editer"
    document.querySelectorAll(".edit-btn").forEach(button => {
        button.addEventListener("click", function () {
            const serviceId = this.getAttribute("data-id");
            window.location.href = `/service/edit?id=${serviceId}`; // Redirection vers la page de modification
    ...
    // Réattacher les événements aux nouveaux boutons "Supprimer"
    document.querySelectorAll(".delete-btn").forEach(button => {
        button.addEventListener("click", function () {
            serviceToDelete = this.getAttribute("data-id");
            openPopup(); // Ouvrir la fenêtre de confirmation
    ...
    if (searchInput) {
        searchInput.addEventListener("input", function() {
            ...
            filterServices(searchTerm); // Filtrer les services en fonction de la saisie
        });
    }
});
...
// Fonction pour rediriger vers la page d'ajout de service
