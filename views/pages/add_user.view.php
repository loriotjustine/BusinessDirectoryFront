<body class="hidden">
    <div class="bg-gray-200 rounded-xl p-8 mx-4 mt-4 mb-8 shadow-lg text-black">
        <!-- Conteneur des boutons Retour et Ajouter un user -->
        ...
        <!-- Formulaire de création de user -->
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form id="createUserForm">
                ...
                <!-- Liste déroulante site de l'user -->
                <div class="mb-4">
                ...
                <!-- Liste déroulante service de l'user -->
                <div class="mb-4">
                ...
                <!-- Liste déroulante rôle de l'user -->
                <div class="mb-4">
